...
# Preserve POD/local-cluster basis artifacts and trained manifold files
...
# Remove reduced-mesh split products while keeping POD basis/reference + manifold files
